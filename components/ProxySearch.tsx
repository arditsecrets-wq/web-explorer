...
import { launchInStealthMode, processSearchQuery } from '../utils/cloaking';

const ProxySearch: React.FC = () => {
        ...
        <div className="space-y-6">
          ...
          <div className="max-w-md mx-auto">
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                {copied ? <Check className="w-4 h-4 text-emerald-400" /> : <Copy className="w-4 h-4 text-zinc-500 group-hover:text-white transition-colors" />}
              </div>
          ...
          {showWarning && (
            <div className="max-w-xl mx-auto p-5 rounded-2xl bg-blue-500/5 border border-blue-500/10 text-xs text-zinc-400 leading-relaxed text-left animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              Many major sites (Google, YouTube, etc.) forbid being displayed in a "Shadow Window" for security.
              <div className="mt-2 space-y-2">
                <p>• <strong>The Fix:</strong> Use frame-friendly search engines like DuckDuckGo (default).</p>
                <p>• <strong>Advanced:</strong> If a site fails, try visiting it directly or use a dedicated Web Unblocker service.</p>
              </div>
            </div>
          )}
        </div>
